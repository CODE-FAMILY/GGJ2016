...
//TO DO!!!!!!!!!!!
var starter = new monster("Blob", 5, fist, "images/starter.png",playa.enemyLvl);

//Monsters
var skeleton = new monster("Skeletor", 100, dagger, "images/skeletonImg.png",playa.enemyLvl);
...
var ghost = new monster("Ghost", 100, whip, "images/ghostImg.png",playa.enemyLvl);
...
var zombie = new monster("Zombie", 100, pistol, "images/emo-zombie.svg",playa.enemyLvl);
...
var zombieNazi = new monster("Nazi Zombie", 100, rifle, "images/zombieNaziImg.png",playa.enemyLvl);
...
var mermaid = new monster("Mermaid", 100, wand, "images/mermaidImg/png",playa.enemyLvl);
...
var minitaur = new monster("Minitaur", 100, whip, "images/minitaurImg.png",playa.enemyLvl);
...
var centaur = new monster("Centaur", 100, fish, "images/centaurImg.png",playa.enemyLvl);
...
var teletubby = new monster("Teletubby", 100, rayGun, "images/teletubbyImg.png",playa.enemyLvl);
teletubby.Desc = ""; 

var bunny = new monster("Bunny", 100, rocket, "images/bunnyImg.png",playa.enemyLvl);
...
//Bosses
var pikachu = new monster("Pikachu", 1000, rayGun, "images/pikachuImg.png",playa.enemyLvl);
...
var trump = new monster("Trump", 1000, fish, "images/trumpImg.png",playa.enemyLvl);
//.Desc = "";

var dragon = new monster("Dragon", 1000, whip, "images/dragonImg.png",playa.enemyLvl);
...
var hitler = new monster("Hitler", 1000, pistol, "images/hitlerImg.png",playa.enemyLvl);
//.Desc = "";

var santa = new monster("Santa", 1000, rocket, "images/snataImg.png",playa.enemyLvl);
