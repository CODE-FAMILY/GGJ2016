...
//Monsters
var skeleton = new monster("Skeletor", 100, dagger, "images/the_rest_of_them/skeleton_2nd_face.svg","images/the_rest_of_them/skeleton_2nd_face.svg",playa.enemyLvl);
...
var zombie = new monster("Zombie", 100, pistol, "images/the_rest_of_them/zombie_2nd_face.svg","images/the_rest_of_them/zombie_2nd_face.svg",playa.enemyLvl);
...
var centaur = new monster("Centaur", 100, fish, "images/centaurImg.svg","images/centaurImg.svg",playa.enemyLvl);
...
var unicorn = new monster("Unicorn", 100, wand, "images/the_rest_of_them/unicorn_2nd_face.svg","images/the_rest_of_them/unicorn_2nd_face.svg",playa.enemyLvl);
...
//Sets
var pentMonsters = [minitaur,unicorn]; //mermaid, centaur, teletubby
var pentBoss = [minitaur]; //trump, santa

var pokeMonsters = [ bunny,unicorn]; //, unicorn
var pokeBoss = [dragon,pikachu]; //pikachu

var tomeMonsters = [zombie, zombieNazi, ghost,skeleton]; //skeleton, 
var tomeBoss = [hitler];